...
const Tasks = ({tasks, toggleTask, deleteTask, updateTaskText, isDarkMode}) => {
  ...
  const incompleteTasks = tasks?.incomplete || [];
  ...
  return (
    <View style={styles.tasks}>
      ...
      <View style={styles.listContainer}>
        <FlatList
          data={tasks.incompleted}
          keyExtractor={(item, index) => index.toString()}
          renderItem={({item, index}) => {
            console.log('Incomplete Task Item:', item); 
            return (
              <View style={styles.taskContainer}>
                ...
                <FlatList
                  ...
                  renderItem={({item: image, index: imageIndex}) => {
                    console.log('Image in Task:', image); 
                    return (
      ...
      <View style={styles.listContainer}>
        <FlatList
          ...
          keyExtractor={(item, index) => index.toString()}
          renderItem={({item, index}) => {
            console.log('Completed Task Item:', item); 
            return (
              <View style={styles.taskContainer}>
                <Checkbox
                  isDarkMode={isDarkMode}
