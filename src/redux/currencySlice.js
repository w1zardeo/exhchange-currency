...
// export const fetchCurrencies = createAsyncThunk('currencies/fetchCurrencies', async (_, { rejectWithValue }) => {
//   try {
...
//           return null; // Return null in case of error to prevent breaking the app
//         }
//       })
//     );

//     return currenciesArray.filter(Boolean); // Filter out any null entries
//   } catch (error) {
